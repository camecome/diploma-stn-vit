...
def train(args, model):
    ...
    logger.info("  Total number of toptimization steps = %d", t_total)
...
def main():
    ...
    parser.add_argument("--dataset", choices=["imagenet1k"], default="imagenet1k", help="Which downstream task.")
    parser.add_argument(
        "--model_type",
    ...
    parser.add_argument(
        "--output_dir", default="output", type=str, help="The output directory where checkpoints will be written."
    )
    ...
    parser.add_argument("--epoch_num", default=300, type=int, help="Total number of epochs to train the model.")
